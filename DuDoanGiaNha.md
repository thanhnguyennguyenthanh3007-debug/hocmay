...
Ngoài kết quả trên màn hình, chương trình tự động tạo thư mục `hinh_anh` với
cấu trúc đầu ra tương tự bài mẫu:
...
├── kfold_visualization.png
├── learning_curve.png
└── final_comparison.png
```

Trong đó, các hình lần lượt thể hiện việc so sánh mô hình, hiện tượng
overfitting, kết quả K-Fold, learning curve và giá thực tế so với giá dự đoán.
